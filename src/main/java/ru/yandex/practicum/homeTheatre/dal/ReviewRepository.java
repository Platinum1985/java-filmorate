...
@Slf4j
@Repository
public class ReviewRepository extends ru.yandex.practicum.homeTheatre.dal.BaseRepository<Review> {
    ...
    public Review getReviewById(int reviewId) {
        ...
        if (review.isEmpty()) {
            throw new NoFoundIdException("Отзыв с таким id не найден");
        } else {
            return review.get();
        }
    }
